...
## 1863: Battle of Gettysburg [![](https://s.w.org/images/core/emoji/13.1.0/svg/1f4fd.svg)](https://www.youtube.com/watch?v=DUXpCfcJ7Ng)
...
Everything from policing to banking to voting is built on Jim Crow, and Jim Crow is as widespread and influential today as it has ever been. Racial segregation is higher than ever in many parts of the country today, and we see corporations and governments deliberately using those black neighborhoods as dumping grounds for hazards that then impact black people instead of white people.
