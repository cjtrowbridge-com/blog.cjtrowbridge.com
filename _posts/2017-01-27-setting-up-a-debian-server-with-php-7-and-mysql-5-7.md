...
You will be prompted to create a new root password for the mysql installation, and then give that password to mysql\_secure\_installation so it can run.
