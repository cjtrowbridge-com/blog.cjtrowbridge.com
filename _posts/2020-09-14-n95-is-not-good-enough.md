...
There are several levels of filter standards. N is a basic one. P is the highest standard. It does a lot more than I need; filtering out organic acids and gaseous oils. It also jumps from filtering just 95% of particulates to filtering 99.9% of airborn particulate matter. HUGE IMPROVEMENT! Also, these filter masks are not medical so no doctors are going to miss out to let me breathe easier.
